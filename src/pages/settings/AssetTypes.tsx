...
import { useCategoriesWithTypes, useToggleAssetType } from '@/hooks/useAssetConfig';
...
const IconMap: Record<string, typeof Coins> = {
  ...
  MapPin,
  Package,
  HandCoins: Wallet, // Fallback
};

export default function AssetTypesSettings() {
  const { data: categories, isLoading } = useCategoriesWithTypes();
      ...
      <div className="p-4 lg:p-8 space-y-6">
        ...
        <div className="space-y-6">
          {categories?.map((category) => {
            ...
            return (
              <Card key={category.id} className="shadow-luxury">
                <CardHeader>
